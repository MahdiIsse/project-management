...
function ColumnContainer(props: Props) {
  ...
  if (isDragging) {
    return (
      <div
        ref={setNodeRef}
        style={style}
        className="bg-column-background w-[350px] h-[500px] max-h-[500px] rounded-md flex flex-col opacity-40 border-2 border-rose-500"
      ></div>
    );
  }
  ...
  return (
    ...
    >
      ...
      {/* Column footer */}
      <button
        className="flex gap-2 items-center border-column-background border-2 rounded-md p-4 border-x-column-background hover:bg-main-background hover:text-rose-500 active:bg-black"
        onClick={() => {
