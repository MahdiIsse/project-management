...
import { getColumnColorByBorder } from "@/features/task-management/utils";
...
export function StatusSelector({
  ...
  const currentColumnColor = getColumnColorByBorder(currentColumn?.border);
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" className="w-48">
        {columns.map((column) => {
          const columnColor = getColumnColorByBorder(column.border);
