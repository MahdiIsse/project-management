...
import { TaskForm, ColumnForm } from "../..";
import { TaskTableRow } from "./TaskTableRow";
import { useDeleteColumn } from "../../hooks";
import { useSortable } from "@dnd-kit/sortable";
import { CSS } from "@dnd-kit/utilities";
import { cn } from "../../../../shared";
import { getColumnColorByBorder } from "../../utils/columnColors";
...
export function StatusTable({
  ...
  const { mutate: deleteColumn } = useDeleteColumn(workspaceId);
  ...
  const { columnBg, columnText } = getColumnColorByBorder(column.color);
