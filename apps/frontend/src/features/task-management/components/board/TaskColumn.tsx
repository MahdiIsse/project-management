...
import { getColumnColorByHex } from "../../utils/columnColors";
...
export function TaskColumn({
  ...
  const { mutate: deleteColumn, isPending: isDeleting } = useDeleteColumn(workspaceId);
  ...
  return (
    ...
    >
      ...
      <Separator className={cn("border-t-2", getColumnColorByHex(column.color || undefined).border)} />
