...
import type { Assignee } from '@/features/project-management';
...
export function AssigneeSelector({
  ...
  const { mutate: addAssignee, isPending: isAdding } =
    useAddAssigneeToTask(workspaceId);
  const { mutate: removeAssignee, isPending: isRemoving } =
    useRemoveAssigneeFromTask(workspaceId);
